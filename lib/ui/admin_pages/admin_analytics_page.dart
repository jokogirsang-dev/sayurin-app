          ...
          return SingleChildScrollView(
            ...
            child: Column(
              ...
              children: [
                      ...
                      children: [
                        ...
                        ClipRRect(
                          ...
                          child: LinearProgressIndicator(
                            value: ((analytics['completedOrders'] as int) /
                                    ((analytics['totalOrders'] as int) > 0
                        ...
                        Text(
                          'Completion Rate: ${(((analytics['completedOrders'] as int) / ((analytics['totalOrders'] as int) > 0 ? (analytics['totalOrders'] as int) : 1)) * 100).toStringAsFixed(1)}%',
                          style: const TextStyle(
                            fontSize: 12,
                            color: Colors.grey,
                          ),
                      ...
                      child: Column(
                        children: categoryData.entries.map((entry) {
                          final percentage = (entry.value /
                                  (analytics['totalProducts'] as int)) *
                              100;
                          return Padding(
                    ...
                    child: Column(
                      children: [
                        _buildStatusRow(
                          ...
                          total: analytics['totalOrders'] as int,
                          color: Colors.green,
                        ),
                        const SizedBox(height: 12),
                        _buildStatusRow(
                          label: 'Pending',
                          count: analytics['pendingOrders'] as int,
                          total: analytics['totalOrders'] as int,
                          color: Colors.orange,
                        ),
                      ],
                ...
                const SizedBox(height: 12),
                ...((analytics['lowStockProducts'] as List).isNotEmpty
                    ? [
                        Card(
                          color: Colors.red[50],
                          child: Padding(
                                ...
                                Expanded(
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      Text(
                                        '${(analytics['lowStockProducts'] as List).length} produk memiliki stok < 5 unit',
